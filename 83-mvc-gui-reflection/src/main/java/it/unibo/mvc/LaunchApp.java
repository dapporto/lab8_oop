...
public final class LaunchApp {
    ...
    public static void main(final String... args) throws NoSuchMethodException, SecurityException {
        ...
        final Class<DrawNumberSwingView> viewSwing = DrawNumberSwingView.class;
        final Class<DrawNumberStandardOutputView> viewStdout = DrawNumberStandardOutputView.class;
    }
}
